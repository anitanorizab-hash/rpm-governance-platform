          ...
          <table className="w-full min-w-[820px] text-left text-sm">
            <thead className="bg-slate-50 text-xs uppercase tracking-wide text-slate-500">
              <tr>
                ...
                <th className="px-4 py-2 font-medium">Org Type</th>
                <th className="px-4 py-2 font-medium">Org Name</th>
            ...
            <tbody className="divide-y divide-slate-100">
              {rows.length === 0 ? (
                <tr><td colSpan={9} className="px-4 py-6 text-center text-slate-500">No import batches.</td></tr>
              ) : rows.map((b) => (
                <tr key={b.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-4 py-2 text-slate-600">{b.organisation_type || "—"}</td>
                  <td className="px-4 py-2 text-slate-600">{b.organisation_name || "—"}</td>
